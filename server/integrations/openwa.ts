...
export const openwaIntegration = {
  ...
  sendImage: (config: OpenwaConfig, sessionId: string, payload: { chatId: string; url?: string; base64?: string; mimetype?: string; filename?: string; caption?: string; quotedMessageId?: string }) => request<{ messageId: string; timestamp: number }>(config, { method: "POST", path: `/sessions/${encodeURIComponent(sessionId)}/messages/send-image`, body: payload }),
  sendVideo: (config: OpenwaConfig, sessionId: string, payload: { chatId: string; url?: string; base64?: string; mimetype?: string; filename?: string; caption?: string; quotedMessageId?: string }) => request<{ messageId: string; timestamp: number }>(config, { method: "POST", path: `/sessions/${encodeURIComponent(sessionId)}/messages/send-video`, body: payload }),
  sendAudio: (config: OpenwaConfig, sessionId: string, payload: { chatId: string; url?: string; base64?: string; mimetype?: string; filename?: string; caption?: string; quotedMessageId?: string; ptt?: boolean }) => request<{ messageId: string; timestamp: number }>(config, { method: "POST", path: `/sessions/${encodeURIComponent(sessionId)}/messages/send-audio`, body: payload }),
  sendDocument: (config: OpenwaConfig, sessionId: string, payload: { chatId: string; url?: string; base64?: string; mimetype?: string; filename?: string; caption?: string; quotedMessageId?: string }) => request<{ messageId: string; timestamp: number }>(config, { method: "POST", path: `/sessions/${encodeURIComponent(sessionId)}/messages/send-document`, body: payload }),
