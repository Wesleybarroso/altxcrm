...
export const domains = mysqlTable("domains", {
  ...
  dnsTarget: varchar("dnsTarget", { length: 255 }),
...
export const appointments = mysqlTable("appointments", {
  ...
  whatsappSessionId: varchar("whatsappSessionId", { length: 120 }),
...
export const workspaceSettings = mysqlTable("workspaceSettings", {
  ...
  providerLabel: varchar("providerLabel", { length: 160 }),
  integrationEndpoint: varchar("integrationEndpoint", { length: 1024 }),
